...
containerName="step_1_1" # Juste un nom qu'on souhaite donner à notre container
portNumber="80"          # Numéro du port qu'on souhaite utiliser (http://127.0.0.1:80)
...
# endregion
docker run -d -v $(pwd):/var/www/html -p ${portNumber}:80 \
